  ...
  return (
    <View style={styles.container}>
      <View style={styles.cardContainer}>
        ...
        <Image style={styles.image} source={{uri:"https://www.iconpacks.net/icons/2/free-incoming-mail-icon-2577-thumb.png"}} />
        ...
        <Text style={styles.lastChange}>Last Change: {data.lastChange}</Text>
